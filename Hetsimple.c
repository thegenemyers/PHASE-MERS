...
{ Kmer_Stream *T;
  ...
  { Kmer_Stream  *T, *U;
    ...
    { int64  Gto, Guo, Gbo;
      ...
      printf("\nGood k-mers:\n");
      printf("    A only: %10lld  %.2f%%\n",Gto,(100.*Gto)/(Gto+Guo+Gbo));
      printf("    B only: %10lld  %.2f%%\n",Guo,(100.*Guo)/(Gto+Guo+Gbo));
      printf("   A and B: %10lld  %.2f%%\n",Gbo,(100.*Gbo)/(Gto+Guo+Gbo));

      printf("\nGood het-mers:\n");
      printf("    A only: %10lld  %.2f%%\n",Hto,(100.*Hto)/(Hto+Huo+Hbo));
      printf("    B only: %10lld  %.2f%%\n",Huo,(100.*Huo)/(Hto+Huo+Hbo));
      printf("   A and B: %10lld  %.2f%%\n",Hbo,(100.*Hbo)/(Hto+Huo+Hbo));
    } 
